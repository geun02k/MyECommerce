...
public class ProductPolicy {
    ...
    public void validateRegister(ServiceProductDto productDto,
        ...
        // 상품옵션목록 중복체크 정책
        enforceOptionCodeUniquenessPolicy(member.getId(),
                                          productDto.getCode(),
    ...
    public void validateModify(Product product,
        ...
        enforceOptionCodeUniquenessPolicy(
                product.getSeller(), product.getCode(), insertOptionList);
    }
    ...
    private void enforceOptionCodeUniquenessPolicy(Long sellerId, String productCode,
        ...
        List<Product> duplicatedOptions =
                productOptionRepository.findBySellerAndProductCodeAndOptionCodeIn(
                        sellerId, productCode, deduplicatedOptionCodes.stream().toList());
